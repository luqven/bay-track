                ...
                <div className="input-field z-depth-1" style={{height: 40}}>
                    ...
                    />
                        <label className="label-icon" htmlFor="search">
                            <i style={{marginTop: 10}} className="material-icons">search</i>
                        </label>
                    <i style={{ marginTop: 5 }} onClick={clearName} className="material-icons"> close </i>
                </div>
                <button className="btn waves-effect waves-light blue accent-3">search</button>
            </form>
